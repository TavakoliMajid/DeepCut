...
model_path = "D:\\Users\\Majid\\RES_NET\\New_Networks\\Resnet50_small.pth"
...
# Define model with matching fc layer
model = resnet50(weights=None)
model.fc = nn.Sequential(
    nn.ReLU(),
    nn.Linear(model.fc.in_features, 2)  # Match your trained model
)
