...
model_path = "D:\\Users\\Majid\\RES_NET\\New_Networks\\mobilenet_v3_small_best.pth"
...
# Load model (MobileNet V3 Small)
model = mobilenet_v3_small(weights=None)
model.classifier[3] = nn.Linear(model.classifier[3].in_features, 2)  # For 2 classes
...
df.to_csv("mobilenet_v3_small_results.csv", index=False)
print("✅ Results saved to mobilenet_v3_small_results.csv")
